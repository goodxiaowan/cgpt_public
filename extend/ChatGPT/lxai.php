...
class lxai
{
    ...
    protected static $chatApiHost = 'https://mj.cxhao.com';
    protected static $drawApiHost = 'https://mj.cxhao.com';
    ...
    {
        $url = self::$drawApiHost . '/mj/submit/imagine';
        $post = [
            'prompt' => $option['prompt'],
        ];
        if (!empty($option['imageurl'])) {
            $post['prompt'] = $option['imageurl'] . ' ' . $option['prompt'];
        }
    ...
    {
        $url = self::$drawApiHost . '/mj/submit/change';
        $post = [
            'taskId' => $option['id'],
            'action' => strtoupper($option['type']),
            'index' => $option['index'],
