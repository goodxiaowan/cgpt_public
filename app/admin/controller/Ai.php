...
class Ai extends Base
{
    ...
    public function saveAiSetting()
    {
        try {
            ...
            if (!in_array($name, ['wenxin', 'wenxin4', 'azure_openai3', 'azure_openai4', 'xunfei', 'tongyi', 'hunyuan', 'hunyuan4', 'zhipu', 'zhipu4', 'lxai', 'chatglm', 'minimax', 'skychat', 'openai3', 'diy32', 'diy33', 'openai4', 'diy42', 'diy43', 'claude2', 'gemini', 'openllm', 'localai', 'kimi', 'baichuan', 'deepseek', 'shangtang', 'doubao'])) {
